...
type ReachingDefinitionsSet interface {
	...
	// basic block. Note that this does not include definitions of the register
	// in the basic block itself, and it is up to the implementation to track.
	// This DOES include definitions of the register in inserted phi functions,
	// including phi functions in the entry this basic block.
...
type SsaConstructionScheme interface {
	...
	// to define the provided (already renamed) register.
	...
	NewRenamedRegister(*gen.RegisterInfo) *gen.RegisterInfo
