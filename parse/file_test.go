					...
					Parameters: []parse.ParameterNode{
						{
							...
							Register: parse.RegisterNode{TokenNode: parse.TokenNode{srcView.Subview(18, 20)}},
						},
						{
							Type:     parse.TypeNode{Identifier: srcView.Subview(21, 24)},
							Register: parse.RegisterNode{TokenNode: parse.TokenNode{srcView.Subview(25, 27)}},
						},
					},
							...
							Targets: []parse.TargetNode{
								{
									...
									Register: parse.RegisterNode{TokenNode: parse.TokenNode{srcView.Subview(35, 39)}},
								},
							},
						},
						{
							...
							Arguments: []parse.ArgumentNode{
								parse.RegisterNode{TokenNode: parse.TokenNode{srcView.Subview(57, 61)}},
							},
						},
					},
				},
