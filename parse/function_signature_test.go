		...
		Parameters: []parse.ParameterNode{
			{
				...
				Register: parse.RegisterNode{TokenNode: parse.TokenNode{reg.View}},
			},
		},
	}
		...
		Parameters: []parse.ParameterNode{
			{
				...
				Register: parse.RegisterNode{TokenNode: parse.TokenNode{param1Reg.View}},
			},
			{
				Type:     parse.TypeNode{Identifier: param2Typ.View},
				Register: parse.RegisterNode{TokenNode: parse.TokenNode{param2Reg.View}},
			},
		},
